...
func ToGinLogger() gin.HandlerFunc {
	return logger.ToGinLogger()
}

func ToGinRecovery(stack bool) gin.HandlerFunc {
	return logger.ToGinRecovery(stack)
}
...
func (ll *defaultLogger) ToGinLogger() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		ctx.Next()
	}
}

func (ll *defaultLogger) ToGinRecovery(stack bool) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		ctx.Next()
	}
}
...
func (ll *defaultLogger) Print(v ...any) {
	ll.stdlog.Print(v...)
}
