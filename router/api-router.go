...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/oauth/google/endpoint", middleware.CriticalRateLimit(), controller.GoogleEndpoint)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/private-groups", controller.ListPrivateGroups)
				selfRoute.GET("/private-groups/joined", controller.ListJoinedPrivateGroups)
				selfRoute.POST("/private-groups", middleware.CriticalRateLimit(), controller.CreatePrivateGroup)
				selfRoute.PUT("/private-groups/:id", controller.UpdatePrivateGroup)
				selfRoute.DELETE("/private-groups/:id", controller.DeletePrivateGroup)
				selfRoute.GET("/private-groups/:id/invite-codes", controller.ListPrivateGroupInviteCodes)
				selfRoute.POST("/private-groups/:id/invite-codes", middleware.CriticalRateLimit(), controller.CreatePrivateGroupInviteCode)
				selfRoute.PATCH("/private-groups/:id/invite-codes/:code_id", controller.UpdatePrivateGroupInviteCode)
				selfRoute.GET("/private-groups/:id/members", controller.ListPrivateGroupMembers)
				selfRoute.DELETE("/private-groups/:id/members/:user_id", controller.DeletePrivateGroupMember)
				selfRoute.POST("/private-groups/redeem", middleware.CriticalRateLimit(), controller.RedeemPrivateGroupInviteCode)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/admin/private-groups", controller.AdminListPrivateGroups)
				adminRoute.PUT("/admin/private-groups/:id", controller.AdminUpdatePrivateGroup)
				adminRoute.DELETE("/admin/private-groups/:id", controller.AdminDeletePrivateGroup)
				adminRoute.GET("/admin/private-groups/:id/members", controller.AdminListPrivateGroupMembers)
				adminRoute.GET("/admin/private-groups/:id/invite-codes", controller.AdminListPrivateGroupInviteCodes)
				adminRoute.POST("/admin/private-groups/:id/invite-codes", controller.AdminCreatePrivateGroupInviteCode)
				adminRoute.PATCH("/admin/private-groups/:id/invite-codes/:code_id", controller.AdminUpdatePrivateGroupInviteCode)
				adminRoute.GET("/admin/users/:id/private-groups", controller.AdminListUserPrivateGroups)
				adminRoute.POST("/admin/users/:id/private-groups", controller.AdminGrantPrivateGroup)
				adminRoute.DELETE("/admin/users/:id/private-groups/:group_id", controller.AdminRevokePrivateGroup)
